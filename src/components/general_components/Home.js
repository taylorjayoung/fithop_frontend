            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="card listing-preview">
                ...
                <div class="card-body">
                  ...
                  <hr />
                  <a href="http://www.localhost:3001/book" class="btn btn-primary btn-block" style={{color: 'white'}}>Book Now</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="card listing-preview" >
                ...
                <div class="card-body">
                  ...
                  <hr />
                  <a href="http://www.localhost:3001/book" class="btn btn-primary btn-block" style={{color: 'white'}} style={{color: 'white'}}>Book Now</a>
                </div>
              </div>
            </div>
